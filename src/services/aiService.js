// High-Speed 4-Tier AI Waterfall Service (Gemini 3.6 -> Groq -> DeepSeek -> OpenRouter)
...
export const generateClerkingGuide = async (query) => {
  ...
  // Tier 1: Google Gemini 3.6 Flash (Tuned for maximum speed)
  if (GEMINI_KEY) {
    try {
      console.log("Tier 1: Calling Gemini 3.6 Flash (Fast mode)...");
  ...
  // Tier 2: Groq (Llama-3.3 70B - Superfast inference)
  if (GROQ_KEY) {
    try {
